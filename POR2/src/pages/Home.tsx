  ...
  return (
    <div className="mx-auto pt-20 pb-10 px-6 h-full flex justify-center flex-col">
      ...
      <div> 
        ...
        <h2 className='text-center text-3xl font-bold mt-30 mb-10'>Take a look at my recent projects!</h2>
      ...
      <div className="flex flex-col gap-10">
        <h3 className="text-center mt-20 mb-15 font-bold text-3xl">Congrats! You made it this far. Let me tell you some fun facts about me! Yay</h3>
        <div className="flex flex-row items-center gap-10 m-auto">
            <div className="w-80 h-60">
            <img src="/horsie.jpg" alt="Horse" className="mb-3 h-[100%] w-[100%] object-cover rounded-2xl" />

            </div>
            <p>I have ridden horses since i was 7/8 years old. I have had my own for 10 years, which
                i have trained myself and competed nationally with! 
            </p>
        </div>
        <div className="flex flex-row items-center gap-10 m-auto">
            <div className="w-80 h-60">
            <img src="/zelda-painting.jpg" alt="Zelda art" className="mb-3 h-[100%] w-[100%] object-contain rounded-2xl" />

            </div>
            <p>I love painting and drawing, but i dont do this too often. I usually sit 
        ...
        <div className="flex flex-row items-center gap-10 m-auto">
            ...
            <p>I recently started bouldering, which is a type of rock climbing.
        ...
        <div className="flex flex-row items-center gap-10 m-auto">
            ...
            <p>I have flown a helicopter! (with a pilot watching me of course). This was super cool!
